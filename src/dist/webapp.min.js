...
$(document).ready(function(){$(".hamburger").click(function(){$(this).toggleClass("is-active")}),$("#workcarousel").carousel({interval:!1}),$("#homepgcarousel").carousel({interval:4e3,pause:!1});var e=$(window).height(),h=($("header").height(),$(".awardbx").height()),r=($(".hm-bannerimg").height(),e-(107+h));$(".hm-bannerimg").css("height",r+"px"),$(".hmcarousel-control").css("height",r+"px");var a=$(".embed-responsive").height();$(".carousel-control").css("height",a+"px")});